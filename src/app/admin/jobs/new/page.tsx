      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {success ? (
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-neon-green mb-4">Job Created Successfully!</h2>
            <p className="text-muted-foreground mb-6">
              Your job posting has been created and is ready to be approved.
            </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-neon-blue/10 border border-neon-blue/30 rounded-lg">
                    ...
                    <label htmlFor="approved" className="text-sm text-foreground">
                      Approve this job immediately (will appear on homepage)
                    </label>
                  </div>
